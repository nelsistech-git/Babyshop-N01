...
class Payslips(BrowsableObject):
    ...
    def sum_category(self, code, from_date, to_date=None):
        ...
        self.env['hr.payslip']._flush(['credit_note', 'employee_id', 'state', 'date_from', 'date_to'])
        self.env['hr.payslip.line']._flush(['total', 'slip_id', 'category_id'])
        self.env['hr.salary.rule.category']._flush(['code'])
