...
class HrPayroll(Controller):
    ...
    def get_payroll_report_print(self, list_ids='', **post):
        ...
        for payslip in payslips:
            ...
            xml_id = report.xml_id

            #pdf_content, _ = report._render_qweb_pdf('hr_payroll.action_report_payslip', payslip.id)
            pdf_content, _ = report._render_qweb_pdf(xml_id, payslip.id)
