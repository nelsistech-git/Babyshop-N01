    ...
    def employee_attendance_data_process(self, employee, from_dt, to_dt, hr_att=None):
        ...
        for day in all_dates:
            ...
            if hr_att:
                ...
                if hr_att.resource_calendar_id:
                    calendar_id = hr_att.resource_calendar_id
                ...
                if hr_att1:
                    ...
                    if hr_att1.resource_calendar_id:
                        calendar_id = hr_att1.resource_calendar_id

            #----------------
            # check_in_start = timedelta(hours=int(calendar_id.check_in_start),
            #                            minutes=(calendar_id.check_in_start * 60) % 60,
            #                            seconds=0)
            # check_in_end = timedelta(hours=int(calendar_id.check_in_end), minutes=(calendar_id.check_in_end * 60) % 60,
            #                          seconds=0)
