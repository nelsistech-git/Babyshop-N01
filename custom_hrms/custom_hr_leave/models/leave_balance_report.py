...
class LeaveBalanceReport(models.Model):
    ...
    user_work_location_id = fields.Many2one('stock.location', string="Work/Job Location", ondelete='restrict',
                                            related='employee_id.user_work_location_id',
        ...
        for employee_id in employee_ids:
            ...
            for allocation in leave_allocation_ids:
                if allocation.holiday_status_id.id not in balances_dict:
                    ...
                    balances_dict[allocation.holiday_status_id.id]['allocated'] = \
                    balances_dict[allocation.holiday_status_id.id]['allocated'] + allocation.number_of_days
            ...
            for leave in leave_ids:
                if leave.holiday_status_id.id not in balances_dict:
                    ...
                    balances_dict[leave.holiday_status_id.id]['taken'] = balances_dict[leave.holiday_status_id.id][
