...
class FoPropertyCounter(models.Model):
    ...
    belonging_ids = fields.One2many('fo.belongings',
                                    'property_counter_id',
                                    string="Visitor Carrying Items", copy=False,
...
class FoBelongings(models.Model):
    ...
    property_name = fields.Char(string="Visitor Carrying Items",
                                help='The name of the Property')
    property_count = fields.Char(string="Count", help='Count of property')
    proof = fields.Selection([
        ('black', 'Black'),
        ('green', 'Green'),
        ('coffee', 'Coffee'),
        ('dark_coffee', 'Dark Coffee'),
        ('khaki', 'Khaki Color'),
    ], string='Proof', help='Proof color selection')
