odoo.define('@whatsapp_connector/chatroom_mod/ai-inteface-form', ['@web/core/utils/patch', '@odoo/owl', '@whatsapp_connector/chatroom_mod/chatroom-action-tab', '@whatsapp_connector/chatroom_mod/conversation-model'], function (require) {
